...
export { HorizontalRule, BulletList, Document, Heading, ListItem, OrderedList, Paragraph, Text, Blockquote, Image }; // Added HorizontalRule to exports

export const buildEditorNodes = (options?: EditorExtensionsOptions) => [
  HorizontalRule, // Wasn't imported
  Document,
  BlockquoteEditor,
  Paragraph.configure({
    HTMLAttributes: {
